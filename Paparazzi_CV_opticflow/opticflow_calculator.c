...
#define OPTICFLOW_FAST9_THRESHOLD 30
  ...
  #if OPTICFLOW_CORNER_METHOD_CAMERA2 == 0 
    #define OPTICFLOW_FAST9_THRESHOLD_CAMERA2 100
  #else 
    #define OPTICFLOW_FAST9_THRESHOLD_CAMERA2 30
  #endif
#endif
...
#define OPTICFLOW_METHOD 0     // TODO: Keep to 0 
#endif
...
#define OPTICFLOW_TRACK_BACK_CAMERA2 TRUE
#endif
                             ...
                             struct opticflow_result_t *result)
{
  ...
  if (opticflow->show_flow) {
    uint8_t color[4] = {255, 255, 0, 0};
    uint8_t bad_color[4] = {0, 0, 0, 255};
