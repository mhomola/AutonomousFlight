...
//#include "modules/dynamic_window_navigation/DWN.h"     //insert green detection function here; header file
...
float obstacle_free_confidence = 5; //get percentage of red pixels instead of 0.8 //0;   // a measure of how certain we are that the way ahead is safe.
