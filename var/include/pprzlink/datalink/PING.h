/** @file
 *  @brief PPRZLink message header for PING in class datalink
 *
 *  
 *  @see http://paparazziuav.org
 */

#ifndef _VAR_MESSAGES_datalink_PING_H_
#define _VAR_MESSAGES_datalink_PING_H_
 ...
 */
#define pprzlink_msg_send_PING _send_msg(PING,PPRZLINK_DEFAULT_VER)

/**
 * Sends a PING message (API V2.0 version)
 *
 * @param msg the pprzlink_msg structure for this message
 */
static inline void pprzlink_msg_v2_send_PING(struct pprzlink_msg * msg) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_named_byte(msg, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_PING, "PING");
...
#endif // _VAR_MESSAGES_datalink_PING_H_
