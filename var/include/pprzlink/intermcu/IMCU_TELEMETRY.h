 ...
 * @param nb_msg,_msg 
 */
static inline void pprzlink_msg_v2_send_IMCU_TELEMETRY(struct pprzlink_msg * msg, uint8_t nb_msg, uint8_t *_msg) {
...
#define DOWNLINK_SEND_IMCU_TELEMETRY(_trans, _dev, nb_msg, msg) pprz_msg_send_IMCU_TELEMETRY(&((_trans).trans_tx), &((_dev).device), AC_ID, nb_msg, msg)
/**
 ...
 * @param nb_msg,_msg 
 */
static inline void pprz_msg_send_IMCU_TELEMETRY(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t nb_msg, uint8_t *_msg) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_IMCU_TELEMETRY(&msg,nb_msg,_msg);
}


#else // DOWNLINK

#define DOWNLINK_SEND_IMCU_TELEMETRY(_trans, _dev, nb_msg, msg) {}
static inline void pprz_send_msg_IMCU_TELEMETRY(struct transport_tx *trans __attribute__((unused)), struct link_device *dev __attribute__((unused)), uint8_t ac_id __attribute__((unused)), uint8_t nb_msg __attribute__((unused)), uint8_t *_msg __attribute__((unused))) {}
