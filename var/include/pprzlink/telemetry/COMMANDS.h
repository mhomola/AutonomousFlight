/** @file
 *  @brief PPRZLink message header for COMMANDS in class telemetry
 *
 *  
 *  @see http://paparazziuav.org
 */

#ifndef _VAR_MESSAGES_telemetry_COMMANDS_H_
#define _VAR_MESSAGES_telemetry_COMMANDS_H_
 ...
 */
#define pprzlink_msg_send_COMMANDS _send_msg(COMMANDS,PPRZLINK_DEFAULT_VER)

/**
 * Sends a COMMANDS message (API V2.0 version)
 *
 * @param msg the pprzlink_msg structure for this message
 * @param nb_values,_values 
 */
static inline void pprzlink_msg_v2_send_COMMANDS(struct pprzlink_msg * msg, uint8_t nb_values, int16_t *_values) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_named_byte(msg, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_COMMANDS, "COMMANDS");
...
#define pprzlink_msg_v1_send_COMMANDS pprz_msg_send_COMMANDS
...
/**
 * Sends a COMMANDS message (API V1.0 version)
 *
...
static inline void pprz_msg_send_COMMANDS(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint8_t nb_values, int16_t *_values) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_COMMANDS(&msg,nb_values,_values);
}
...
#endif // _VAR_MESSAGES_telemetry_COMMANDS_H_
