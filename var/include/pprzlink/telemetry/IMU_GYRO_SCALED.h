 ...
 * @param _gr 
 */
static inline void pprzlink_msg_v2_send_IMU_GYRO_SCALED(struct pprzlink_msg * msg, int32_t *_gp, int32_t *_gq, int32_t *_gr) {
...
static inline void pprz_msg_send_IMU_GYRO_SCALED(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int32_t *_gp, int32_t *_gq, int32_t *_gr) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_IMU_GYRO_SCALED(&msg,_gp,_gq,_gr);
}
