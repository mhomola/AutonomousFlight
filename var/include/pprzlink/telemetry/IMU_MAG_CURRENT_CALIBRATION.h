 ...
 */
static inline void pprzlink_msg_v2_send_IMU_MAG_CURRENT_CALIBRATION(struct pprzlink_msg * msg, int32_t *_mx, int32_t *_my, int32_t *_mz, float *_electrical_current) {
 ...
 * @param _electrical_current 
 */
static inline void pprz_msg_send_IMU_MAG_CURRENT_CALIBRATION(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, int32_t *_mx, int32_t *_my, int32_t *_mz, float *_electrical_current) {
