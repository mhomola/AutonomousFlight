/** @file
 *  @brief PPRZLink message header for PONG in class telemetry
 *
 *  Answer to PING datalink message, to measure latencies
 *  @see http://paparazziuav.org
 */

#ifndef _VAR_MESSAGES_telemetry_PONG_H_
#define _VAR_MESSAGES_telemetry_PONG_H_
 ...
 */
#define pprzlink_msg_send_PONG _send_msg(PONG,PPRZLINK_DEFAULT_VER)

/**
 * Sends a PONG message (API V2.0 version)
 *
 * @param msg the pprzlink_msg structure for this message
 */
static inline void pprzlink_msg_v2_send_PONG(struct pprzlink_msg * msg) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_named_byte(msg, _FD, DL_TYPE_UINT8, DL_FORMAT_SCALAR, DL_PONG, "PONG");
...
#endif // _VAR_MESSAGES_telemetry_PONG_H_
